  ...
  if (isMobile) {
    return (
      <>
        ...
        {/* Mobile Sidebar */}
        <nav className={cn(
          "fixed top-0 left-0 h-full w-64 bg-white/95 backdrop-blur-xl border-r border-gray-100 shadow-lg z-50 transform transition-transform duration-300 md:hidden",
