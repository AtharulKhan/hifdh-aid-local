      ...
      <Card className="p-4 md:p-6 border-l-4 border-l-green-500">
        <div className="space-y-4 md:space-y-6">
          <div className="text-center">
            <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-2">First Verse Test</h2>
          ...
          <div className="bg-green-50 p-3 md:p-4 rounded-lg border border-green-200">
            <div className="text-center space-y-3">
              ...
              <div className="text-2xl md:text-3xl font-bold text-gray-800 break-words">
